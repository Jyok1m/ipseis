				...
				<div className="mx-auto max-w-5xl">
					<div className="relative grid grid-cols-1 gap-4 sm:gap-0 sm:grid-cols-3 sm:grid-rows-3">
						...
						<div className="sm:col-start-1 sm:row-start-1">
							<div className="p-4 bg-support rounded-3xl shadow-lg border-[1px] border-maitrise text-maitrise h-full sm:h-[260px] text-center flex flex-col justify-center items-center">
						...
						<div className="sm:col-start-2 sm:row-start-2">
							<div className="p-6 bg-maitrise rounded-3xl shadow-lg border-[1px] border-maitrise text-support h-full sm:h-[320px] text-center flex flex-col justify-center items-center relative z-20 sm:-mt-8 sm:-mb-8 sm:-mx-6">
