...
export default function ApprenantDashboard() {
	...
	return (
		<div>
			<h1 className="text-2xl font-bold text-gray-900 mb-6">Espace Apprenant</h1>

			<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-6">
				<div className="flex items-start gap-4">
					<AcademicCapIcon className="h-10 w-10 text-maitrise flex-shrink-0" />
					<div>
						<h2 className="text-xl font-bold text-gray-900 mb-1">
							Bienvenue, {user?.firstName} {user?.lastName}
						</h2>
						<p className="text-gray-500">Retrouvez ici vos informations, contrats et suivi pédagogique.</p>
					</div>
				</div>
			</div>
			...
			{contractStats.pending > 0 && (
				<div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 flex items-center justify-between gap-4">
					...
					<Link
						href="/espace-personnel/apprenant/contrats"
			...
			{unreadMessages > 0 && (
				<div className="bg-univers/5 border border-univers/20 rounded-xl p-4 mb-6 flex items-center justify-between gap-4">
					...
					<Link
						href="/espace-personnel/apprenant/messages"
				...
				<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
					<div className="flex items-center justify-between mb-4">
						...
						<InfoTooltip title="Tous les contrats" description="Voir la liste complète de vos contrats, les signer ou les consulter.">
							<Link href="/espace-personnel/apprenant/contrats" className="text-sm text-univers hover:underline font-semibold">
								Voir tous
							</Link>
						</InfoTooltip>
					</div>
			...
			<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
				<div className="flex items-center justify-between mb-4">
					...
					<InfoTooltip title="Toutes les ressources" description="Accéder à l'ensemble de vos documents PDF et supports de formation.">
						<Link href="/espace-personnel/apprenant/formations" className="text-sm text-univers hover:underline font-semibold">
							Voir toutes
						</Link>
					</InfoTooltip>
				</div>
