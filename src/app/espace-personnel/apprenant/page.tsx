		...
		<div>
			...
			<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
				<div className="flex items-start gap-4">
					<AcademicCapIcon className="h-10 w-10 text-gray-400 flex-shrink-0" />
					<div>
						<h2 className="text-xl font-bold text-gray-900 mb-2">
							Bienvenue, {user?.firstName} {user?.lastName}
						</h2>
						<p className="text-gray-500">
							Votre espace apprenant est en cours de construction. Vous retrouverez bientôt ici vos formations, vos documents et votre suivi pédagogique.
						</p>
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
				...
				<div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
					...
					<p className="text-sm text-gray-500">
						Accès à vos formations, documents pédagogiques, attestations et certificats de réalisation.
					</p>
				</div>
			</div>
		</div>
